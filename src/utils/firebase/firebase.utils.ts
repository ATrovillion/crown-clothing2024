...
// function for uploading categories to firestore
...
export const getCategoriesAndDocuments = async (): Promise<Category[]> => {
  ...
  // ts doesn't know that firebase sends back querysnapshot, so we cast as category
  // because we know that's how the data comes back in the promise
